...
void TreeBillboardApp::UpdateMaterialCBs(const GameTimer& gt)
{
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 6> TreeBillboardApp::GetStaticSamplers()
{
...
XMFLOAT3 TreeBillboardApp::GetHillsNormal(float x, float z)const
{
	XMFLOAT3 n(
